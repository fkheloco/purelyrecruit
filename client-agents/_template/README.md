# {{CLIENT_NAME}} — Client Agent Package

This is a portable, self-contained agent workspace for {{CLIENT_NAME}}. You can copy this entire folder to share access with team members who only work on this client. No other client data is included.
...
Quick Start
1) Review and customize Claude.md with {{CLIENT_NAME}} specifics
...
Security & Access
- Share only this folder to limit access to {{CLIENT_NAME}} materials
